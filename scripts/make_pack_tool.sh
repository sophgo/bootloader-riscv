...
if [ "$1" = "mango" ];then
    ...
    gcc $RV_SCRIPTS_DIR/pack/pack_v3.c -DSG2042 -o $RV_FIRMWARE_INSTALL_DIR/pack_v3
    ...
    gcc $RV_SCRIPTS_DIR/pack/pack_v3.c -DSG2044 -o $RV_FIRMWARE_INSTALL_DIR/pack_v3	
